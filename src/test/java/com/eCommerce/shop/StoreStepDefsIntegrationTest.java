...
public class StoreStepDefsIntegrationTest  extends SpringIntegrationTest {

	 StoreDto storeDto;
	  
	 @When("^the client calls to get store with Store Id \"([^\"]*)\"$")
	    public void the_clinet_issue_store_get(String id) throws Throwable {
		    System.out.println("Executing Cucumber test - the_clinet_issue_get");
		    storeDto = (StoreDto)getRestObject("/store/"+id, StoreDto.class);
